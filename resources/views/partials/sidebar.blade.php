...
<div class="sidebar-area" id="sidebar-area">
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu active" data-simplebar>
        <ul class="menu-inner">
            ...
            <li class="menu-item">
                <a href="{{ route('user.index') }}" class="menu-link {{ Request::is('jobs-pdm') ? 'active' : '' }}"  id="loadJobs">
                    <span class="material-symbols-outlined menu-icon">date_range</span>
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="/1" class="menu-link {{ Request::is('/1') ? 'active' : '' }}">
                            eCommerce
                        </a>
                    </li>
                    <li class="menu-item">
            ...
            <li class="menu-title small text-uppercase">
                <span class="menu-title-text">APPS setan</span>
            </li>
